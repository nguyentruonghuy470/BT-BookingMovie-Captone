...
const Footer = () => {
  ...
  return (
    <div id="Footer">
      <div className="app" id="ungDung">
        <Container size="md" px="xs" >
          <Grid grow className="gridApp">
            <Grid.Col span={4}>
              <ScrollAnimation animateIn="fadeIn" duration={0.5} delay={0.5}>
                <TypographyStylesProvider>
                  <Text
                    component="h1"
                    variant="gradient"
                    gradient={{ from: "#CED4DA", to: "#868E96", deg: 45 }}
                    size="xl"
                    weight={700}
                  ...
                  <Button color="red" size="lg" uppercase className="mt-3">
                    App miễn phí - Tải về ngay!
                  </Button>
                  <Title order={3} color="#E9ECEF">
                    TIX có hai phiên bản{" "}
                    <Text component="a" color="blue" inherit>
                      IOS
                    </Text>{" "}
                    &
                    <Text component="a" color="blue" inherit>
            ...
            <Grid.Col span={4} className="jss138 appRight">
              <ScrollAnimation animateIn="fadeInRight">
                ...
                ></img>
                <div className="containerCaurousel">
                  <Carousel
                    activeIndex={index}
                  ...
                  >
                    <Carousel.Item>
                      <img
                        className="imgMobile"
                        src="https://tcdtist-tix-clone.vercel.app/static/media/banner-slider-5.8a084f78.jpg"
                        alt="hinhanh1"
                      />
                    </Carousel.Item>
                    <Carousel.Item>
                      <img
                        className="imgMobile"
                        src="https://tcdtist-tix-clone.vercel.app/static/media/banner-slider-2.454924ec.jpg"
                        alt="hinhanh2"
                      />
                    </Carousel.Item>
                    <Carousel.Item>
                      <img
                        className="imgMobile"
                        src="https://tcdtist-tix-clone.vercel.app/static/media/banner-slider-1.c4d5fe9e.jpg"
                        alt="hinhanh3"
                      />
                    </Carousel.Item>
                    <Carousel.Item>
      ...
      <footer>
        <Container size="md" px="xs">
          <Grid grow className="girdFooter">
            <Grid.Col span={5}>
              <TypographyStylesProvider>
                <Text
                  component="h6"
            ...
            <Grid.Col span={4}>
              <TypographyStylesProvider>
                ...
                <Grid grow>
                  <Grid.Col span={2}>
                    <img src={images.image1} className="imgLogo" />
                  </Grid.Col>
                  <Grid.Col span={2}>
                    <img src={images.image2} className="imgLogo" />
                  </Grid.Col>
                  <Grid.Col span={2}>
                    <img src={images.image3} className="imgLogo" />
                  </Grid.Col>
                  <Grid.Col span={2}>
                    <img src={images.image4} className="imgLogo" />
                  </Grid.Col>
                </Grid>
              </TypographyStylesProvider>
            </Grid.Col>
              ...
              <TypographyStylesProvider>
                <Grid grow>
                  <Grid.Col span={2}>
                    ...
                    <Grid grow>
                      <Grid.Col span={2}>
                        <img src={images.iconIos} className="imgLogo" />
                      </Grid.Col>
                      <Grid.Col span={2}>
                        <img src={images.iconArd} className="imgLogo" />
                      </Grid.Col>
                    </Grid>
                  </Grid.Col>
                  <Grid.Col span={2}>
                    ...
                    <Grid grow>
                      <Grid.Col span={2}>
                        <img src={images.iconZalo} className="imgLogo" />
                      </Grid.Col>
                      <Grid.Col span={2}>
                        <img src={images.iconFace} className="imgLogo" />
                      </Grid.Col>
                    </Grid>
                  </Grid.Col>
                </Grid>
